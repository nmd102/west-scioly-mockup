          ...
          <div id={styles.grid}>
            <Link href="/blog">
              <article className="link2">
                <div className={styles.outer}>
                  <h2>blog/news</h2>
                  <Image src="/west-scio-mockup/media/arrow.svg" className={styles.arrow} alt="Arrow right" width={50} height={50}/>
                </div>
                <div className={styles.inner}>
                  <Image src="/west-scio-mockup/media/idea.svg" alt="Lightbulb idea icon" width={500} height={500}/>
                  <div>
                    <h3>         MWSO updates                      </h3>
                    <h3>          blog/news                </h3>
                  </div>
            ...
            <Link href="/photo-gallery">
              <article className="link1">
                ...
                <div className={styles.inner}>
                  <Image src="/west-scio-mockup/media/tools.svg" alt="Tools icon" width={500} height={500}/>
                  <div>
                    <h3>             see stuff           </h3>
                    <h3>          also kevin          </h3>
                  </div>
            ...
            <Link href="/sponsors">
              <article className="link3">
                ...
                <div className={styles.inner}>
                  <Image src="/west-scio-mockup/media/people.svg" alt="People icon" width={500} height={500}/>
                  <div>
                    <h3>   we&#39;re broke         </h3>
                    <h3>         give $$$            </h3>
